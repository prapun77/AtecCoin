...
const char * const BITCOIN_CONF_FILENAME = "ateccoin.conf";
const char * const BITCOIN_PID_FILENAME = "ateccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ateccoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ateccoin";
#else
    // Unix
    return pathRet / ".ateccoin";
#endif
#endif
}
