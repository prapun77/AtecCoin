...
# zip unix binaries
#mkdir -p ./bin/unix
#cp -v ./src/ateccoind ./bin/unix/
#cp -v ./src/ateccoin-cli ./bin/unix/
#cp -v ./src/ateccoin-tx ./bin/unix/
#cp -v ./src/test/test_ateccoin ./bin/unix/
#cp -v ./src/bench/bench_ateccoin ./bin/unix/
#cp -v ./src/qt/ateccoin-qt ./bin/unix
#cp -v ./src/qt/test/test_ateccoin-qt ./bin/unix
#cp -v ./ateccoin.conf ./bin/unix/
#zip ./bin/ateccoin-unix.zip ./bin/unix/*

WIN_ZIP_FILENAME=ateccoin-x86_64-win64-vx.zip
...
#cp -v ./src/qt/test/test_ateccoin-qt.exe $WIN_RELEASE_FOLDER/
